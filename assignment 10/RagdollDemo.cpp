...
{
    // reading 'weights.dat' and putting values into weights[i][j]
    /*
    using namespace std;
    ...
    ifstream myfile;
    myfile.open("/Users/mijitninja/Documents/bullet-2.82-r2704/Demos/RagdollDemo/weights.dat");
        ...
        */
        ...
        if(timeStep%10 == 0){
            for (int i=0; i<8; i++) {
                ...
                for (int j=0; j<4; j++) {
                    motorCommand = motorCommand + weights[j][i]*touches[i];
                }
